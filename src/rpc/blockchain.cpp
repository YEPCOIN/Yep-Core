...
UniValue blockToJSON(const CBlock& block, const CBlockIndex* blockindex, bool txDetails = false)
{
    ...
    UniValue zyepObj(UniValue::VOBJ);
    for (auto denom : libzerocoin::zerocoinDenomList) {
        zyepObj.push_back(Pair(to_string(denom), ValueFromAmount(blockindex->mapZerocoinSupply.at(denom) * (denom*COIN))));
    }
    zyepObj.push_back(Pair("total", ValueFromAmount(blockindex->GetZerocoinSupply())));
    result.push_back(Pair("zyepsupply", zyepObj));
...
UniValue getchecksumblock(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 2 || params.size() > 3)
        throw runtime_error(
            ...
            "  \"zyepsupply\" :\n"
            "  {\n"
            "     \"1\" : n,            (numeric) supply of 1 zyep denomination\n"
            "     \"5\" : n,            (numeric) supply of 5 zyep denomination\n"
            "     \"10\" : n,           (numeric) supply of 10 zyep denomination\n"
            "     \"50\" : n,           (numeric) supply of 50 zyep denomination\n"
            "     \"100\" : n,          (numeric) supply of 100 zyep denomination\n"
            "     \"500\" : n,          (numeric) supply of 500 zyep denomination\n"
            "     \"1000\" : n,         (numeric) supply of 1000 zyep denomination\n"
            "     \"5000\" : n,         (numeric) supply of 5000 zyep denomination\n"
            "     \"total\" : n,        (numeric) The total supply of all zyep denominations\n"
            "  }\n"
            "}\n"
...
UniValue getaccumulatorwitness(const UniValue& params, bool fHelp)
{
    ...
    if (!GenerateAccumulatorWitness(pubCoin, accumulator, witness, nMintsAdded, strFailReason)) {
        receipt.SetStatus(_(strFailReason.c_str()), zyep_FAILED_ACCUMULATOR_INITIALIZATION);
