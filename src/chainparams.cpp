...
static Checkpoints::MapCheckpoints mapCheckpoints = 
	...
	(0, uint256("0x00000e40f797dcf5b27e6e1c9d255a8efe9898789f750b7a08175df2af1fa324"));
...
static Checkpoints::MapCheckpoints mapCheckpointsRegtest =
    boost::assign::map_list_of(0, uint256("0x00000e40f797dcf5b27e6e1c9d255a8efe9898789f750b7a08175df2af1fa324"));
...
public:
	...
	//vTreasuryRewardAddress="DKv8dUifgBKkWM1nwjad7yNasQ41yA9ntR";
        ...
        nDefaultPort = 30361;
        bnProofOfWorkLimit = ~uint256(0) >> 20; // yep starting difficulty is 1 / 2^12
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // yep: 1 day  
        nTargetSpacing = 1 * 60; //yep: 1 Min
        nMaturity = 30;
        nMasternodeCountDrift = 20;
        nMasternodeCollateralLimit = 20000; //MN collateral
        nMaxMoneyOut = 70000000 * COIN; //21 mill
      ...
      //  nSupplyBeforeFakeSerial = 4131563 * COIN;   // zerocoin supply at block nFakeSerialBlockheightEnd
        ...
        const char* pszTimestamp = "YEP was born 2018";
	...
	hashGenesisBlock = genesis.GetHash();
        ...
        assert(hashGenesisBlock == uint256("0x00000e40f797dcf5b27e6e1c9d255a8efe9898789f750b7a08175df2af1fa324")); 
        assert(genesis.hashMerkleRoot == uint256("0x9b4178d15121dbe8346ea8f8ab2ca82e0f42241351adf0aa7493d5fefda3f1fe")); 

	vFixedSeeds.clear();
        vSeeds.clear();
        // DNS Seeding
        vSeeds.push_back(CDNSSeedData("95.179.181.48", "95.179.181.48"));
        vSeeds.push_back(CDNSSeedData("95.179.148.33", "95.179.148.33"));
        vSeeds.push_back(CDNSSeedData("45.77.62.128", "45.77.62.128"));
        vSeeds.push_back(CDNSSeedData("45.32.237.61", "45.32.237.61"));
	...
	base58Prefixes[EXT_SECRET_KEY] = list_of(0x02)(0x21)(0x31)(0x2B).convert_to_container<std::vector<unsigned char> >();
        ...
        strSporkKey = "04e29f0ee81f8346244915fa3b12483d21a083b936b644f9634cd54563500cb948388fe4e878b9e2648b9776f6721a7ea083ec3b983fd94b3ebfc994666ecd4f3e";
        strObfuscationPoolDummyAddress = "YKv8dUifgBKkWM1nwjad7yNasQ41yA9ntR";
...
public:
	...
	pchMessageStart[0] = 0xa0;
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // yep: 1 day
        nTargetSpacing = 1 * 60;  // yep: 1 minute
        nLastPOWBlock = 2000;
        nMaturity = 32;
...
//	assert(genesis.hashMerkleRoot == uint256("0x7c3f1b5874e38c421d07fc20ce79ddb3bbaad19cdbad903a0b185070d6005b8c"));
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
       // vSeeds.push_back(CDNSSeedData("testnet.yep.io", "testnet.yep.io"));         // Single node address
       // vSeeds.push_back(CDNSSeedData("testnet1.yep.io", "testnet1.yep.io"));       // Single node address
       // vSeeds.push_back(CDNSSeedData("testnet2.yep.io", "testnet2.yep.io"));
...
public:
    CRegTestParams()
    {
        ...
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // yep: 1 day
        nTargetSpacing = 1 * 60;        // yep: 1 minutes
