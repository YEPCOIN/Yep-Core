...
extern bool fGlobalUnlockSpendCache; // Bool used for letting the precomputing thread know that zyepspends need to use the cs_spendcache
...
enum AvailableCoinsType {
    ...
    ONLY_DENOMINATED = 2,
    ONLY_NOT10000IFMN = 3,
    ONLY_NONDENOMINATED_NOT10000IFMN = 4, // ONLY_NONDENOMINATED and not 10000 YEP at the same time
...
public:
    ...
    string GetUniqueWalletBackupName(bool fzyepAuto) const;
    ...
    */
    ...
    CzyepWallet* getZWallet() { return zwalletMain; }
    ...
    /// Get 5000YEP input and keys which can be used for the Masternode
