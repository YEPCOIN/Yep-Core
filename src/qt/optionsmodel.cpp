...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nAnonymizeyepAmount"))
        settings.setValue("nAnonymizeyepAmount", 1000);

    nAnonymizeyepAmount = settings.value("nAnonymizeyepAmount").toLongLong();
...
QVariant OptionsModel::data(const QModelIndex& index, int role) const
{
    if (role == Qt::EditRole) {
        ...
        case AnonymizeyepAmount:
            return QVariant(nAnonymizeyepAmount);
        case Listen:
...
bool OptionsModel::setData(const QModelIndex& index, const QVariant& value, int role)
{
    ...
    if (role == Qt::EditRole) {
        ...
        case HideOrphans:
            ...
            break;
        case AnonymizeyepAmount:
            nAnonymizeyepAmount = value.toInt();
            settings.setValue("nAnonymizeyepAmount", nAnonymizeyepAmount);
            emit anonymizeyepAmountChanged(nAnonymizeyepAmount);
            break;
        case CoinControlFeatures:
