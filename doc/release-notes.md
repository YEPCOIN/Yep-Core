...
Yep Core version *version* is now available from:  <https://github.com/yep-project/yep/releases>
...
A full report provided by yep developers is available on the [yep Website](https://yep.io/fake-stake-official-yep-report/), which includes additional findings, mitigation details, and resources for testing. This type of attack has no risk to users' privacy and does not affect their holdings.
...
A full technical writeup of the protocol can be found [Here](https://yep.io/wp-content/uploads/2018/11/Zerocoin_Light_Node_Protocol.pdf).
