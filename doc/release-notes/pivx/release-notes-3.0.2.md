Yep Core version 3.0.2 is now available from:
...
Yep Core v3.0.2 is a recommended, semi-mandatory update for all users. This release contains transaction creation bug fixes for zyep spends, automint calculation adjustments, and other various updates/fixes.
