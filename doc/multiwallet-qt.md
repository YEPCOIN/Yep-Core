...
In order to support loading of multiple wallets in yep-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is yep.cpp.
...
Changes to yep.cpp
----------------------
yep.cpp is the entry point into yep-qt, and as such, will require some minor modifications to provide hooks for
