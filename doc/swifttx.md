...
This mechanism has been integrated into Bitcore-Node-yep which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/yep-Project/insight-api-yep#web-socket-api](https://github.com/yep-Project/insight-api-yep#web-socket-api) 
* API: [https://github.com/yep-Project/insight-api-yep#swifttx-transactions](https://github.com/yep-Project/insight-api-yep#swifttx-transactions) 
...
By default, the Yep Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Yep Core daemon:
